...
const Page = () => {
  return (
    <section className="bg-slate-100 dark:bg-black p-10 rounded-xl">
      <div className="container">
        <h2 className="text-4xl font-medium md:text-6xl">Open Positions</h2>
            ...
            <ul className="divide-y divide-border border-y border-border">
              {department.roles.map((role) => (
                <li key={role.id} className="group">
                  <a href={role.href} className="flex items-center py-6 group-hover:text-orange-400">
                    <div>
